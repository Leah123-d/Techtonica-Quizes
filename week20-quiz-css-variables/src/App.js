...
function App() {
    ...
    const newColor = getComputedStyle(document.documentElement).getPropertyValue('--logo-color');
        ...
        <div className="App">
            <header className="App-header">
                ...
                <p onClick={onSVGClick}>
                    ...
                    {/* REACT SVG */}
                    <svg className="App-logo" xmlns="public/logo512.png" viewBox="0 0 841.9 595.3">
                        <g fill="#61DAFB">
                            <path
